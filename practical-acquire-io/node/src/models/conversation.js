...
module.exports.bySession = function(params, callback){
    return getBySession(params).then(function(results){
        callback(null, results);
    }).catch((err) => {
        callback(err, null);
    })
...
const getBySession = (params) => {
    var conditions = [];
    params.sessions.forEach(function(session){
...
module.exports.createConversation = function(params, callback){
